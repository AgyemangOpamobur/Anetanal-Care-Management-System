...
if (isset($_POST['btn-Search']))
{
     ...
     $actualId = $getID[1];
      ...
      $database->check_if_id_exist($actualId);
}
?>
...
<br><br>
  ...
  <br>
    ...
    <form class="" action="Postnatal-First-Visit-Search.php" method="post">
    <div id="page-wrap">
      <table  width="180%" height="200" cellspacing="20" cellpadding="20">
          <thead>
            <tr>
              <th><center><h3 style="color: red;"> Postnatal Search</h3></center></th>
            </tr>
          </thead>
