...
$MaternalHealth = new Methods();
if (isset($_POST['btn-Save'])) {
    $MaternalHealth->Maternal_Health_Records();
}
?>
...
<body>
  ...
  <form class="" action="Maternal-Health-Records.php" method="post">
      ...
      <table  width="180%" height="200" cellspacing="20" cellpadding="20">
          ...
          <table  width="180%"height="200" cellspacing="20" cellpadding="20">
            ...
            <tbody>
              ...
              <td>
                <textarea id="bordershadow" name="maternalHealth" rows="60" cols="100"  class="col-xs-1"style="width:85%; height: 90%; font-size: 16px; position: relative; left: 100px" required></textarea>
              </td>
            </tbody>
          </table>
