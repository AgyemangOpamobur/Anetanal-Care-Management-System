...
if (isset($_POST['search'])) {
  try {
    ...
    if (empty($searchName)) {
      echo "<script> alert('Please enter patient Name'); window.location.href='View-Emergency-Consultation.php';</script>";
    }else {
    ...
    echo "<script> alert('Name can not be found in the list.'); window.location.href='View-Emergency-Consultation.php';</script>";
  }
}
...
<head>
  <meta charset="utf-8">
  <title>View Emergency Consultation </title>
</head>
...
<body>
  ...
  <br>
  <form class="form-inline header-search-form my-2 my-lg-0" action="View-Emergency-Consultation.php" method="POST" >
    <div id="page-wrap">
      <br>
      <center>
        <input class="" type="text"  id="" placeholder="Search by Name (First Name and Last Name)" aria-label="Search" style="width:45%; height: 70%; font-size: 18px;" name="searchName">
        &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <br>
    <form class="" action="View-Emergency-Consultation.php" method="POST">
    <div id="page-wrap">
          ...
          <table border="1" width="200%"height="100" cellspacing="50" cellpadding="50">
            ...
            <tbody>
              ...
              if ($searchNameFlag == false) {
                foreach ($conn->query("SELECT * from emergencyconsultation   where status = 'Not Yet' order by DateReceived ASC") as $row) {
              ?>
                <tr>
                ...
                <td><center>
                  ...
                  ?>
                          <a class="btn btn-sm btn-primary" href="View-Emergency-Consultation.php?del=Updated">Update</a></center></td>
                  <?php
               }else {
                   ?>
                  <a class="btn btn-sm btn-primary" href="View-Emergency-Consultation.php?update=<?php echo $row{'FID'}?>" >Update</a></center></td>
                  <?php
                }
                   ?>
