...
if (isset($_POST['btn-Search']))
{
  ...
  $getRecord->GetAntenatalExaminationRecords($actualId);
}
?>
...
<head>
  <meta charset="utf-8">
  <title>View Antenatal Examination Search</title>
</head>
...
<br><br>
    <div class="col-xs-offset-3">
      ...
      if(isset($_GET['iderror']))
      {
        ...
        <div class='alert alert-error'>
          ...
          <strong><h4>No Antenatal Examination records for this ID</h4></strong>
        </div>
        <?php
      }
      ?>
  ...
  <br>
    ...
    <br><br>
    <form class="" action="View-Examination-History-search.php" method="post">
    <div id="page-wrap">
      <table  width="180%" height="200" cellspacing="20" cellpadding="20">
          <thead>
            <tr>
              <th><center><h3 style="color: red;">View Antenatal Examination History Search</h3></center></th>
            </tr>
          </thead>
