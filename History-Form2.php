...
$history2 = new Methods();
if (isset($_POST['btn-Save'])) {
    $history2->Antenatal_History2();
}
...
<body>
  ...
  <form class="" action="History-Form2.php" method="post">
            ...
            <tbody>
                  <tr>
                    <td><label for="" class="control-label col-xs-4" style="font-size: 18px;">HYPERTENSION </label>
                      <select class="" id="bordershadow" name="hypertension" style="width:20%; height: 45%; font-size: 16px;" required>
                    ...
                    <td><label for="" class="control-label col-xs-5" style="font-size: 18px;">HEART DISEASE </label>
                      <select class="" id="bordershadow" name="heart_disease" style="width:20%; height: 50%; font-size: 16px;" required>
                        <option value="">Choose...</option>
                        <option value="Yes">YES</option>
                        <option value="No">NO</option>
                      </select>
                  ...
                  <tr>
                    <td><label for="" class="control-label col-xs-4" style="font-size: 18px;">SICKLE CELL DISEASE </label>
                      <select class="" id="bordershadow" name="Medical_sickle_disease" style="width:20%; height: 50%; font-size: 16px;" required>
                        <option value="">Choose...</option>
                        <option value="Yes">YES</option>
                        <option value="No">NO</option>
                      </select>
                    ...
                    <td><label for="" class="control-label col-xs-5" style="font-size: 18px;">DIABETES </label>
                      <select class="" id="bordershadow" name="diabetes" style="width:20%; height: 50%; font-size: 16px;" required>
                        <option value="">Choose...</option>
                        <option value="Yes">YES</option>
                        <option value="No">NO</option>
                      </select>
                  ...
                  <tr>
                    <td><label for="" class="control-label col-xs-4" style="font-size: 18px;">JAUNDICE </label>
                      <select class="" id="bordershadow" name="jaundice" style="width:20%; height: 50%; font-size: 16px;" required>
                        <option value="">Choose...</option>
                        <option value="Yes">YES</option>
                        <option value="No">NO</option>
                      </select>
                    ...
                    <td><label for="" class="control-label col-xs-5" style="font-size: 18px;">RESPIRATORY DISEASE </label>
                      <select class="" id="bordershadow" name="Respiratory_disease" style="width:20%; height: 50%; font-size: 16px;" required>
                        <option value="">Choose...</option>
                        <option value="Yes">YES</option>
                        <option value="No">NO</option>
                      </select>
                  ...
                  <tr>
                    <td><label for="" class="control-label col-xs-5" style="font-size: 18px;">TB, CHRONIC COUGH, ASTHMA </label>
                      <select class="" id="bordershadow" name="TB_Chronic" style="width:20%; height: 50%; font-size: 16px;" required>
                        <option value="">Choose...</option>
                        <option value="Yes">YES</option>
                        <option value="No">NO</option>
                      </select>
                    ...
                    <td><label for="" class="control-label col-xs-5" style="font-size: 18px;">HIV DISEASE </label>
                      <select class="" id="bordershadow" name="Hiv_disease" style="width:20%; height: 50%; font-size: 16px;" required>
                        <option value="">Choose...</option>
                        <option value="Yes">YES</option>
                        <option value="No">NO</option>
                      </select>
                  ...
                  <tr>
                    <td><label for="" class="control-label col-xs-4" style="font-size: 18px;">EPILEPSY </label>
                      <select class="" id="bordershadow" name="Epilepsy" style="width:20%; height: 50%; font-size: 16px;" required>
                        <option value="">Choose...</option>
                        <option value="Yes">YES</option>
                        <option value="No">NO</option>
                      </select>
                    ...
                    <td><label for="" class="control-label col-xs-5" style="font-size: 18px;">MENTAL ILLNESS </label>
                      <select class="" id="bordershadow" name="Mental_illness" style="width:20%; height: 50%; font-size: 16px;" required>
                        <option value="">Choose...</option>
                        <option value="Yes">YES</option>
                        <option value="No">NO</option>
                      </select>
                  ...
                  <tr>
                    <td>
                        <label for="" class="control-label col-xs-5" style="font-size: 18px;">OTHER(SPECIFY)</label><textarea name="Other2" rows="5" cols="30" id="bordershadow" style="width:35%; height: 60%; font-size: 16px;"></textarea>
                    </td>

                    <td>
                        <label for="" class="control-label col-xs-5" style="font-size: 18px;">PREVIOUS OPERATION(SPECIFY)</label><textarea name="Previous_Operation" rows="5" cols="30" id="bordershadow" style="width:35%; height: 60%; font-size: 16px;"></textarea>
                    </td>
          ...
          <tbody>
                <tr>
                  <td><label for="" class="control-label col-xs-5" style="font-size: 18px;">HYPERTENSION </label>
                    <select class="" id="bordershadow" name="Family_hypertension" style="width:25%; height: 35%; font-size: 16px;" required>
                      <option value="">Choose...</option>
                      <option value="Yes">YES</option>
                      <option value="No">NO</option>
                    </select>
                  ...
                  <td><label for="" class="control-label col-xs-5" style="font-size: 18px;">DIABETES </label>
                    <select class="" id="bordershadow" name="Family_diabetes" style="width:20%; height: 35%; font-size: 16px;" required>
                      <option value="">Choose...</option>
                      <option value="Yes">YES</option>
                      <option value="No">NO</option>
                    </select>
                ...
                <tr>
                  <td><label for="" class="control-label col-xs-5" style="font-size: 18px;">SICKLE CELL DISEASE </label>
                    <select class="" id="bordershadow" name="Sickle_disease" style="width:25%; height: 35%; font-size: 16px;" required>
                      <option value="">Choose...</option>
                      <option value="Yes">YES</option>
                      <option value="No">NO</option>
                    </select>
                  ...
                  <td>
                    ...
                    <select class="" id="bordershadow" name="Multiple_pregnancies" style="width:20%; height: 35%; font-size: 16px;" required>
                      <option value="">Choose...</option>
                      <option value="Yes">YES</option>
                      <option value="No">NO</option>
                    </select>
                ...
                <tr>
                  <td><label for="" class="control-label col-xs-5" style="font-size: 18px;">MENTAL HEALTH </label>
                    <select class="" id="bordershadow" name="Family_Mental_health" style="width:25%; height: 35%; font-size: 16px;">
                      <option value="">Choose...</option>
                      <option value="Yes">YES</option>
                      <option value="No">NO</option>
                    </select>
                  ...
                  <td>
                    <label for="" class="control-label col-xs-5" style="font-size: 18px;">BIRTH DEFECTS(SPECIFY)</label>
                      <select class="" id="bordershadow" name="Birth_defects" style="width:20%; height: 35%; font-size: 16px;">
                        <option value="">Choose...</option>
                        <option value="Yes">YES</option>
                        <option value="No">NO</option>
                      </select>
                ...
                <tr>
                  <td><label for="" class="control-label col-xs-5" style="font-size: 18px;">HEART DISEASE </label>
                    <select class="" id="bordershadow" name="Heart_disease" style="width:25%; height: 35%; font-size: 16px;" required>
                      <option value="">Choose...</option>
                      <option value="Yes">YES</option>
                      <option value="No">NO</option>
                    </select></td>
...
<!-- Drug history -->
          ...
          <tbody>
                <tr>
                  <td>
                    ...
                    <textarea name="Drug_history_text" rows="5" cols="30" id="bordershadow" style="width:40%; height: 60%; font-size: 16px;"></textarea>
                  </td>
                  <td>
                    <label for="" class="control-label col-xs-1" style="font-size: 18px;"></label>
                    <select class="" id="bordershadow" name="Drug_history_selection" style="width:40%; height: 25%; font-size: 16px;" required>
                    <option value="">Choose...</option>
                    <option value="Yes">YES</option>
                    <option value="No">NO</option>
                  </select>
        ...
        <table width="100%"height="200" cellspacing="10" cellpadding="10">
          ...
          <tbody>
                <tr>
                  <td>
                    <label for="" class="control-label col-xs-3" style="font-size: 18px;">IF YES(SPECIFY)</label>
                    <textarea name="Allergies_text" rows="5" cols="30" id="bordershadow" style="width:40%; height: 60%; font-size: 16px;"></textarea>
                  </td>
                  <td>
                    <label for="" class="control-label col-xs-1" style="font-size: 18px;"></label>
                    <select class="" id="bordershadow" name="Allergies_history" style="width:40%; height: 25%; font-size: 16px;" required>
                    <option value="">Choose...</option>
                    <option value="Yes">YES</option>
                    <option value="No">NO</option>
                  </select>
                ...
                <tbody>
                        ...
                        <tr>
                          <td>
                            ...
                            <textarea name="Contraceptive_text" rows="5" cols="30" id="bordershadow" style="width:40%; height: 60%; font-size: 16px;"></textarea>
                          </td>
                          <td>
                            <label for="" class="control-label col-xs-1" style="font-size: 18px;"></label>
                            <select class="" id="bordershadow" name="Contraceptive_selection" style="width:40%; height: 25%; font-size: 16px;" required>
                            <option value="">Choose...</option>
                            <option value="Yes">YES</option>
                            <option value="No">NO</option>
                          </select>
                        ...
                        <tr>
                            <td>
                              <label for="" class="control-label col-xs-4" style="font-size: 18px;">DATE DISCONTINUED</label><input id="bordershadow"type="date" name="Contraceptive_Discontinue_date" value="" style="width:20%; height: 70%; font-size: 16px;">
                            </td>
                            <td></td>
                        </tr>
                </tbody>
  ...
  <div id="page-wrap">
    <table width="100%" height="100%" cellspacing="40" cellpadding="40">
        ...
        <table width="180%"height="200" cellspacing="60" cellpadding="60">
          <thead>
            <tr>
            <th></th>
            <th></th>
          ...
          <tbody>
                <tr>
                  <td><label for="" class="control-label col-xs-6" style="font-size: 18px;">CHRONIC LOWER ABDOMINAL PAIN </label>
                    <select class="" id="bordershadow" name="Chronic_pain" style="width:25%; height: 35%; font-size: 16px;" required>
                      <option value="">Choose...</option>
                      <option value="Yes">YES</option>
                      <option value="No">NO</option>
                    </select>
                  ...
                  <td><label for="" class="control-label col-xs-6" style="font-size: 18px;">ITCHING / BURNING SENSATION / SWELLING OF THE GENITALS</label>
                    <select class="" id="bordershadow" name="Itching_pain" style="width:20%; height: 35%; font-size: 16px;" required>
                      <option value="">Choose...</option>
                      <option value="Yes">YES</option>
                      <option value="No">NO</option>
                    </select>
                ...
                <tr>
                  <td><label for="" class="control-label col-xs-6" style="font-size: 18px;">ABNORMAL VAGINAL / URETHRAL DISCHARGE</label>
                    <select class="" id="bordershadow" name="Abnormal_pain" style="width:25%; height: 35%; font-size: 16px;" required>
                      <option value="">Choose...</option>
                      <option value="Yes">YES</option>
                      <option value="No">NO</option>
                    </select>
                  ...
                  <td>
                    ...
                    <select class="" id="bordershadow" name="Genital_sores" style="width:20%; height: 35%; font-size: 16px;" required>
                      <option value="">Choose...</option>
                      <option value="Yes">YES</option>
                      <option value="No">NO</option>
                    </select>
                ...
                <tr>
                  <td><label for="" class="control-label col-xs-6" style="font-size: 18px;">PAINFUL URINATION </label>
                    <select class="" id="bordershadow" name="Urinal_pain" style="width:25%; height: 35%; font-size: 16px;" required>
                      <option value="">Choose...</option>
                      <option value="Yes">YES</option>
                      <option value="No">NO</option>
                    </select>
                  ...
                  <td>
                    <label for="" class="control-label col-xs-6" style="font-size: 18px;">GENITAL LUMPS / GROWTH(wart)</label>
                      <select class="" id="bordershadow" name="Genital_pain" style="width:20%; height: 35%; font-size: 16px;" required>
                        <option value="">Choose...</option>
                        <option value="Yes">YES</option>
                        <option value="No">NO</option>
                      </select>
        ...
        <div id="page-wrap">
          <br>
            <center> <button class="btn btn-large btn-primary" type="submit" name="btn-Save">Save</button>&nbsp;&nbsp;&nbsp;&nbsp;
              <a href="History.php" style="float:middle;" class="btn btn-large">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;
