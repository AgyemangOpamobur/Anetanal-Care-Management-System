...
if (isset($_POST['btn-Send'])) {
  $name  =  $_SESSION['Antenatalfn'];
  $contact = trim($_POST['smsAntenatalcontact']);
  $message = trim($_POST['AntenatalMessageDetails']);
...
<br><br>
<form class="" action="Send-Antenatal-SMS.php" method="post">
        ...
        <tbody>
            <tr>
              <td style="padding: 20px">
                  ...
                  <input type="text" id="bordershadow" name="apId" style="width:35%; height: 80%; font-size: 18px; float: right; position: relative; left: -35%;" value="<?php echo @$_SESSION['smsAntenatalId']; ?>" readonly>
              </td>
            </tr>
            <tr>
              <td style="padding: 20px">
                <center><label for="" class="control-label col-xs-5 " style="font-size: 20px; ">Full Name</label></center>
                <input type="text" id="bordershadow" name="Antenatalfullname" style="width:35%; height: 80%; font-size: 18px; float: right; position: relative; left: -35%;" value="<?php echo @$_SESSION['smsAntenatalFullname']; ?>"  readonly>
              </td>
            </tr>
            <tr>
              <td style="padding: 20px">
                <center><label for="" class="control-label col-xs-5 " style="font-size: 20px; ">Telephone</label></center>
                <input type="text" id="bordershadow" name="smsAntenatalcontact" style="width:35%; height: 80%; font-size: 18px; float: right; position: relative; left: -35%;" value="<?php echo @$_SESSION['smsAntenatalContact'] ;//'0245953446'; ?>" readonly>
              </td>
            </tr>

            <tr>
              <td style="padding: 20px">
                <center><label for="" class="control-label col-xs-5 " style="font-size: 20px; ">Message:</label><textarea id="bordershadow"  name="AntenatalMessageDetails" rows="9" cols="30" style="width:40%; height: 50%; font-size: 16px;position: relative; left: -23%;" placeholder="Write message details here" required></textarea>
              </td>
            </tr>
