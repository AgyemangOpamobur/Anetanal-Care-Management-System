    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <!-- Generate registration code for user -->
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
                <a href="generateRegCode.php" >
              <span class="info-box-icon"><img src="images/regcode" style="width=30%"></i></span>
              <div class="info-box-content">
                <span class="">Generate Reg. Code</span>
              </a>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
                <a href="View-User-Logs.php" >
              <span class="info-box-icon"><img class="" src="images/user" style="width=30%; height=10%"></i></span>
              <div class="info-box-content">
                <span class="">View User-logs</span>
              </a>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
                <a href="Block-Or-Unblock-User.php" >
              <span class="info-box-icon">
                <!--adding image tag with iconmoon as class  -->
                <img class="" src="images/block" style="width=30%"></span>
              <div class="info-box-content">
                <span class="">Block/Unblock User</span>
              </a>
              </div>
            </div>
          </div>
