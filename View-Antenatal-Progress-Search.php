...
if (isset($_POST['btn-Search']))
{
  ...
  $getRecord->GetAntenatalProgressRecords($actualId);
}
?>
  ...
  <div class="col-xs-offset-3">
    ...
    if(isset($_GET['iderror']))
    {
      ...
      <div class='alert alert-error'>
        ...
        <strong><h4>No Antenatal progress records for this ID</h4></strong>
      </div>
      <?php
    }
    ?>
...
<br><br>
<form class="" action="View-Antenatal-Progress-Search.php" method="post">
  <div id="page-wrap">
    <table  width="180%" height="100%" cellspacing="20" cellpadding="20">
      <thead>
        <tr>
          <th><center><h3 style="color: red;">View Antenatal Progress Search</h3></center></th>
        </tr>
      </thead>
