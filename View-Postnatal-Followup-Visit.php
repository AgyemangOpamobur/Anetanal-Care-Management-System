...
$ViewFollowupVisit = new Methods();

$ViewFollowupVisit->GetPostnatalFollowupRecord();

if (isset($_POST['btn-Update'])) {
    $ViewFollowupVisit->Update_Postnatal_Followup_Visit();
}
?>
...
<head>
  <meta charset="utf-8">
  <title>View Postnatal Followup Visit</title>
</head>
...
<body>
  ...
  <form class="" action="View-Postnatal-Followup-Visit.php" method="post">
  ...
  <div id="page-wrap">
    ...
    <div id="page-wrap">
      <table  width="180%" height="200" cellspacing="20" cellpadding="20">
          <thead>
            <tr>
              <th><center><h3 style="color: red; background-color: lightskyblue;   padding:20px;">POSTNATAL(FIRST VISIT 24-48 HOURS)<br><br>CARE OF MOTHER</h3></center></th>
            </tr>
          </thead>
          <table  width="150%"height="200" cellspacing="10" cellpadding="10">
            ...
            <tbody>
                  <tr>
                    <td><label for="" class="control-label col-xs-4" style="font-size: 18px;">Any Complaint:</label><textarea id="bordershadow" colspan="2" name="motherComplaint" rows="9" cols="30" style="width:60%; height: 50%; font-size: 16px; color:#8b008b;"><?php echo @$_SESSION['complaint2']; ?></textarea></td>
                    <td></td>
                    <td></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td><label for="" class="control-label col-xs-5" style="font-size: 18px;">General Condition:</label><label for="" class="control-label col-xs-2" style="font-size: 18px;">Temp:</label><input id="bordershadow" type="text" name="motherTemperature" style="width:30%; height: 70%; font-size: 16px; color:#8b008b;" value="<?php echo $_SESSION['Temperature2']; ?>">
                    </td>
                    <td>
                      <label for="" class="control-label col-xs-3" style="font-size: 18px;">BP:</label><input id="bordershadow" type="text" name="motherBP" style="width:40%; height: 70%; font-size: 16px;color:#8b008b;" value="<?php echo $_SESSION['BP2']; ?>">
                    </td>
                    <td>
                      <label for="" class="control-label col-xs-3" style="font-size: 18px;">Pulse:</label><input id="bordershadow" type="text" name="motherPulse" style="width:40%; height: 70%; font-size: 16px; color:#8b008b;" value="<?php echo $_SESSION['Pulse2']; ?>">
                    </td>
                  </tr>
                  <tr>
                    <td><br></td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <select class="col-xs-3" id="bordershadow" name="motherPallor" class="" style="width:50%; height: 70%; font-size: 16px;color:#8b008b;" >
                        <option value="<?php echo $_SESSION['Pallor2'] ?>"><?php echo $_SESSION['Pallor2']; ?></option>
                    ...
                    <td>
                      ...
                      <select class="col-xs-3" id="bordershadow" name="motherJaundice" class="" style="width:50%; height: 70%; font-size: 16px; color:#8b008b;" >
                        <option value="<?php echo $_SESSION['Jaundice2'] ?>"><?php echo $_SESSION['Jaundice2']; ?></option>
                        <option value="Yes">Yes</option>
                        <option value="No">No</option>
                        </select>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php
                        if (empty($_SESSION['BreastAndNipple2'])) {

                        }
                        elseif ($_SESSION['BreastAndNipple2'] == "Normal") {
                        ?>
                    ...
                    <td>
                        ...
                        <input id="bordershadow" type="text" name="motherBreastAbnormalState" style="width:40%; height: 70%; font-size: 16px; color:#8b008b;" value="<?php echo $_SESSION['BreastAndNipple2']; ?>">
                      <?php } ?>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <select class="col-xs-3" id="bordershadow" name="motherTenderness" class="" style="width:50%; height: 70%; font-size: 16px; color:#8b008b;" >
                        <option value="<?php echo $_SESSION['AbdomenTendernes2']; ?>"><?php echo $_SESSION['AbdomenTendernes2']; ?></option>
                        <option value="Yes">Yes</option>
                        <option value="No">No</option>
                        </select>
                    </td>
                    <td>
                      ...
                      <input id="bordershadow" type="text" name="motherUterusSize" style="width:40%; height: 70%; font-size: 16px; color:#8b008b;" value="<?php echo $_SESSION['UterusSize2']; ?>" >
                    </td>
                  </tr>
                  <tr>
                    <td><label for="" class="control-label col-xs-4" style="font-size: 18px;">Prenium and Lochia:</label><textarea id="bordershadow" colspan="2" name="motherPrenium" rows="9" cols="30" style="width:60%; height: 50%; font-size: 16px; color:#8b008b;"><?php echo $_SESSION['PerineumAndLochia2']; ?></textarea></td>
                    <td></td>
                    <td></td>
                  </tr>
                  <tr>
                      <td>
                        ...
                        <select class="col-xs-3" id="bordershadow" name="motherlimbsCalf" class="" style="width:30%; height: 70%; font-size: 16px; color:#8b008b;" >
                          <option value="<?php echo $_SESSION['LowerLimbsCalfPain2']; ?>"><?php echo $_SESSION['LowerLimbsCalfPain2']; ?></option>
                          <option value="Yes">Yes</option>
                          <option value="No">No</option>
                          </select>
                      </td>
                      <td>
                        ...
                        <select class="col-xs-3" id="bordershadow" name="motherSwelling" class="" style="width:50%; height: 70%; font-size: 16px; color:#8b008b;" >
                          <option value="<?php echo $_SESSION['Swelling2']; ?>"><?php echo $_SESSION['Swelling2']; ?></option>
                          <option value="Yes">Yes</option>
                          <option value="No">No</option>
                          </select>
                      </td>
                  ...
                  <tr>
                    <td>
                        <?php
                          if (empty($_SESSION['TreatmentVitaA2'] )) {

                          }elseif ($_SESSION['TreatmentVitaA2'] == "Vitamin A") {
                        ?>
                    ...
                    <td>
                      ...
                      }elseif ($_SESSION['TreatmentFeloate2'] == "Fe/Folate") {
                      ?>
                        <label for="" class="control-label col-xs-5" style="font-size: 18px;">Fe/Folate:</label>
                    ...
                    <td>
                      <label for="" class="control-label col-xs-5" style="font-size: 18px;">Other(State)</label><textarea id="bordershadow" colspan="2" name="motherOther" rows="9" cols="30" style="width:40%; height: 30%; font-size: 16px; color:#8b008b;"><?php echo  $_SESSION['TreatmentOthers2']; ?></textarea>
                     </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <input id="bordershadow" type="text" name="motherHb" style="width:40%; height: 70%; font-size: 16px; color:#8b008b;" value="<?php echo $_SESSION['LabTestHB2']; ?>" ></td>
                    <td><label for="" class="control-label col-xs-7" style="font-size: 18px;">HIV(offer if not done):</label>
                    <input id="bordershadow" type="text" name="motherHiv" style="width:40%; height: 70%; font-size: 16px; color:#8b008b;" value="<?php echo $_SESSION['LabTestHIV2']; ?>"
                    ></td>
                    <td></td>
                  </tr>
  ...
  <div id="page-wrap">
    <table width="100%" height="200" cellspacing="40" cellpadding="40">
        ...
        <table width="180%"height="200" cellspacing="40" cellpadding="40">
          ...
          <tbody>
                <tr>
                  <td><label for="" class="control-label col-xs-4" style="font-size: 18px;">Any Complaint:</label><textarea id="bordershadow" colspan="2" name="babyCareComplaint" rows="9" cols="30" style="width:60%; height: 50%; font-size: 16px; color:#8b008b;"><?php echo $_SESSION['ComplaintBaby2']; ?></textarea></td>
                  <td></td>
                  <td></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>
                    <label for="" class="control-label col-xs-3" style="font-size: 18px;">Temp:</label><input id="bordershadow" type="text" name="babyTemp" style="width:30%; height: 70%; font-size: 16px; color:#8b008b;" value="<?php echo $_SESSION['TemperatureBaby2']; ?>">
                  </td>
                  <td>
                    <label for="" class="control-label col-xs-4" style="font-size: 18px;">Heart Rate:</label><input id="bordershadow" type="text" name="babyHeartRate" style="width:30%; height: 70%; font-size: 16px;color:#8b008b;" value="<?php echo $_SESSION['HeartRateBaby2']; ?>">
                  </td>
                  <td>
                    ...
                    <select class="col-xs-3" id="bordershadow" name="babyPallor" class="" style="width:55%; height: 70%; font-size: 16px; color:#8b008b;" >
                      <option value="<?php echo $_SESSION['PallorBaby2']; ?>"><?php echo $_SESSION['PallorBaby2']; ?></option>
                      <option value="Yes">Yes</option>
                      <option value="No">No</option>
                      </select>
                  </td>
                ...
                <tr>
                  ...
                  <select class="col-xs-3" id="bordershadow" name="babyJaundice" class="" style="width:30%; height: 70%; font-size: 16px;color:#8b008b;" >
                    <option value="<?php echo @$_SESSION['JaundiceBaby2']; ?>"><?php echo @$_SESSION['JaundiceBaby2']; ?></option>
                    <option value="Yes">Yes</option>
                    <option value="No">No</option>
                    </select>
                  </td>
                  <td>
                    ...
                    <select class="col-xs-3" id="bordershadow" name="babyBreastfeeding" class="" style="width:40%; height: 70%; font-size: 16px; color:#8b008b;" >
                      <option value="<?php echo $_SESSION['BreastfeedingBaby2']; ?>"><?php echo $_SESSION['BreastfeedingBaby2']; ?></option>
                      <option value="Yes">Yes</option>
                      <option value="No">No</option>
                      </select>
                  </td>
                ...
                <select class="col-xs-3" id="bordershadow" name="babyActivity" class="" style="width:30%; height: 70%; font-size: 16px;color:#8b008b;" >
                  <option value="<?php echo $_SESSION['ActivityBaby2']; ?>"><?php echo $_SESSION['ActivityBaby2']; ?></option>
                ...
                <td>
                  ...
                  <select class="col-xs-3" id="bordershadow" name="babyChest" class="" style="width:40%; height: 70%; font-size: 16px;color:#8b008b;" >
                    <option value="<?php echo $_SESSION['ChestBaby2']; ?>"><?php echo $_SESSION['ChestBaby2']; ?></option>
                    <option value="Normal">Normal</option>
                    <option value="Abnormal">Abnormal</option>
                    </select>
                </td>
                <td>
                  ...
                  <select class="col-xs-3" id="bordershadow" name="babyAbdomen" class="" style="width:45%; height: 70%; font-size: 16px; color:#8b008b;" >
                    <option value="<?php echo $_SESSION['AbdomenBaby2']; ?>"><?php echo $_SESSION['AbdomenBaby2']; ?></option>
                    <option value="Normal">Normal</option>
                    <option value="Abnormal">Abnormal</option>
                    </select>
                </td>
              ...
              <select class="col-xs-3" id="bordershadow" name="babyLimbs" class="" style="width:30%; height: 70%; font-size: 16px;color:#8b008b;" >
                <option value="<?php echo $_SESSION['LimbsBaby2']; ?>"><?php echo $_SESSION['LimbsBaby2']; ?></option>
                <option value="Normal">Normal</option>
                <option value="Abnormal">Abnormal</option>
                </select>
              </td>
              <td>
                ...
                <select class="col-xs-3" id="bordershadow" name="babyHead" class="" style="width:40%; height: 70%; font-size: 16px;color:#8b008b;" >
                  <option value="<?php echo $_SESSION['HeadBaby2']; ?>"><?php echo $_SESSION['HeadBaby2']; ?></option>
                  <option value="Normal">Normal</option>
                  <option value="Abnormal">Abnormal</option>
                  </select>
              </td>
              <td>
                ...
                <select class="col-xs-3" id="bordershadow" name="babySpine" class="" style="width:45%; height: 70%; font-size: 16px; color:#8b008b;" >
                  <option value="<?php echo $_SESSION['SpineBackBaby2']; ?>"><?php echo $_SESSION['SpineBackBaby2']; ?></option>
                  <option value="Normal">Normal</option>
                  <option value="Abnormal">Abnormal</option>
                  </select>
              </td>
            ...
            <select class="col-xs-3" id="bordershadow" name="babyUmbilicalCord" class="" style="width:30%; height: 70%; font-size: 16px; color:#8b008b;" >
              <option value="<?php echo $_SESSION['UmblicalCordBaby2']; ?>"><?php echo $_SESSION['UmblicalCordBaby2']; ?></option>
              <option value="Normal">Normal</option>
              <option value="Abnormal">Abnormal</option>
              </select>
            </td>
            <td>
              ...
              <select class="col-xs-3" id="bordershadow" name="babySkin" class="" style="width:40%; height: 70%; font-size: 16px; color:#8b008b;" >
                <option value="<?php echo $_SESSION['SkinBaby2']; ?>"><?php echo $_SESSION['SkinBaby2']; ?></option>
                <option value="Normal">Normal</option>
                <option value="Abnormal">Abnormal</option>
                </select>
            </td>
            <td>
              ...
              <select class="col-xs-3" id="bordershadow" name="babyDicharginEyes" class="" style="width:45%; height: 70%; font-size: 16px; color:#8b008b;" >
                <option value="<?php echo $_SESSION['DischargeEyesBaby2']; ?>"><?php echo $_SESSION['DischargeEyesBaby2']; ?></option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
                </select>
            </td>
          ...
          <select class="col-xs-3" id="bordershadow" name="babyPassingUrine" class="" style="width:30%; height: 70%; font-size: 16px;color:#8b008b;" >
            <option value="<?php echo $_SESSION['PassingUrineBaby2']; ?>"><?php echo $_SESSION['PassingUrineBaby2']; ?></option>
            <option value="Yes">Yes</option>
            <option value="No">No</option>
            </select>
          </td>
          <td>
            ...
            <select class="col-xs-3" id="bordershadow" name="babyPassingStool" class="" style="width:40%; height: 70%; font-size: 16px; color:#8b008b;" >
              <option value="<?php echo $_SESSION['PassingStoolBaby2']; ?>"><?php echo $_SESSION['PassingStoolBaby2']; ?></option>
              <option value="Normal">Normal</option>
              <option value="Abnormal">Abnormal</option>
              </select>
          </td>
        ...
        <tr>
          ...
          <tr>
            <td>
              ...
              <input id="bordershadow" type="text" name="babyVitaminK" style="width:30%; height: 70%; font-size: 16px; color:#8b008b;" value="<?php echo $_SESSION['VitKTreatmentBaby2']; ?>">
            </td>
            <td>
              <label for="" class="control-label col-xs-3" style="font-size: 18px;">BCG:</label>
              <input id="bordershadow" type="text" name="babybcg" style="width:40%; height: 70%; font-size: 16px; color:#8b008b;" value="<?php echo $_SESSION['BCGTreatmentBaby2']; ?>" >
            </td>
            <td>
              <label for="" class="control-label col-xs-5" style="font-size: 18px;">Polio O:</label>
              <input id="bordershadow" type="text" name="babyPolio" style="width:40%; height: 70%; font-size: 16px; color:#8b008b;" value="<?php echo $_SESSION['PolioOTreatmentBaby2']; ?>">
            </td>
          </tr>
          <tr>
            <td><label for="" class="control-label col-xs-4" style="font-size: 18px;">Others:</label><textarea id="bordershadow" colspan="2" name="babyOthers" rows="9" cols="30" style="width:60%; height: 50%; font-size: 16px; color:#8b008b;"><?php echo $_SESSION['OtherTreatmentBaby2']; ?> </textarea></td>
            <td></td>
            <td></td>
          </tr>
          <tr>
          ...
          <tr>
            <td>
              <tr>
                <td><label for="" class="control-label col-xs-4" style="font-size: 18px;">Date of Next Visit:</label><input id="bordershadow" type="date" name="babyNextDate" rows="9" cols="30" style="width:60%; height: 50%; font-size: 16px; color:#8b008b;" value="<?php echo $_SESSION['DateNextVisitBaby2']; ?>"></input></td>
                <td>
                    <label for="" class="control-label col-xs-4" style="font-size: 18px;">Signature of Attending Midwife:</label><input id="bordershadow" type="text" name="babyMidwifeSig" rows="9" cols="30" style="width:60%; height: 50%; font-size: 16px; color:#8b008b;" value="<?php echo $_SESSION['Midwife2']; ?>" ></input>
                </td>
                <td></td>
              </tr>
            </td>
