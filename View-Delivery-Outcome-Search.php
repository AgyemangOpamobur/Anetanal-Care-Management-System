...
$getRecord = new Methods();

if (isset($_POST['btn-Search']))
{
  $search = @trim(strtoupper($_POST['Delivery_Outcome_search']));
  $getID = explode("C", $search);
  $actualId = $getID[1];

  $getRecord->GetDeliveryOutcomeRecords($actualId);
}
?>
...
<head>
  <meta charset="utf-8">
  <title>View Delivery/Labour Search</title>
</head>
  ...
  <div class="col-xs-offset-3">
    ...
    if(isset($_GET['iderror']))
    {
      ...
      <div class='alert alert-error'>
        ...
        <strong><h4>No Antenatal Delivery/Labour records for this ID</h4></strong>
      </div>
      <?php
    }
    ?>
...
<br><br>
<form class="" action="View-Delivery-Outcome-Search.php" method="post">
  <div id="page-wrap">
    <table  width="180%" height="100%" cellspacing="20" cellpadding="20">
      <thead>
        <tr>
          <th><center><h3 style="color: red;">View Labour / Delivery Outcome Search</h3></center></th>
        </tr>
      </thead>
      <table width="200%"height="200" cellspacing="50" cellpadding="50">
        ...
        <tbody>
          ...
          <tr>
            <td>
              <center>
                <input id="bordershadow"type="text" name="Delivery_Outcome_search" value="" class="search col-xs-offset-3" style=" width:60%; height: 100%; font-size: 16px;" placeholder="Example: ANC1" required>
              </center>
            </td>
          </tr>
          <tr>
