...
<head>
  <meta charset="utf-8">
  <title>Report Antenatal Summary Search</title>
</head>
...
<br><br>
    <div class="col-xs-offset-3">
      ...
      if(isset($_GET['data']))
      {
        ...
        <div class='alert alert-error'>
          <button class='close' data-dismiss='alert'>&times;</button>
          <strong><h4>No Antenatal records for this patient.</h4></strong>
        </div>
        <?php
      }
      ?>
  ...
  <br>
    ...
    <form class="" action="Report-Antenatal-Summary-Search.php" method="post">
    <div id="page-wrap">
      <table  width="180%" height="200" cellspacing="20" cellpadding="20">
          <thead>
            <tr>
              <th><center><h3 style="color: red;"> Generate Report on Summary of Antenatal</h3></center></th>
            </tr>
          </thead>
