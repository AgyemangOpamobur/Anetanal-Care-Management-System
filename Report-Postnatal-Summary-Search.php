...
{
     $search = @trim(strtoupper($_POST['report_search']));
     $getID = explode("C", $search);
     $actualId = $getID[1];

      $database->VerifyIfDelivered($actualId);
}
?>
...
<head>
  <meta charset="utf-8">
  <title>Report on Postnatal Care</title>
</head>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <!-- <a class="brand" style="float: right;" href="logout.php">LogOut</a> -->
          <br>
...
<br><br>
    <div class="col-xs-offset-3">
      ...
      if(isset($_GET['dataerror']))
      {
        ...
        <div class='alert alert-error'>
          <button class='close' data-dismiss='alert'>&times;</button>
          <strong><h4>This patient has no labour / Delivery records.</h4></strong>
        </div>
        <?php
      }
      ?>
  ...
  <br>
    ...
    <form class="" action="Report-Postnatal-Summary-Search.php" method="post">
    <div id="page-wrap">
      <table  width="180%" height="200" cellspacing="20" cellpadding="20">
          <thead>
            <tr>
              <th><center><h3 style="color: red;"> Generate Report on Summary of Postnatal Care</h3></center></th>
            </tr>
          </thead>
            ...
            <tbody>
              <label for="" class="control-label col-xs-8 " style="font-size: 18px;">Enter patient_ID here:</label><br>
                  ...
                  <tr>
                    <td>
                      <center>
                    <input id="bordershadow"type="text" name="report_search" value="" class="search col-xs-offset-3" style=" width:60%; height: 100%; font-size: 16px;" placeholder="Example: ANC1" required>
                  </center>
                    </td>
                  </tr>
                  <tr>
                    <td><center> <button class="btn btn-large btn-primary" type="submit" name="btn-Search">Search</button>
                      ...
                      <img src="images/return.png" alt="" width = "50" height ="50"><a href="Report.php" style="float:middle; font-size: 16px" class="">Return</a>
                    </center>
                  </td>
              </tr>
          </tbody>
