...
if(isset($_POST['btn-print'])){
  header("Location: Pdf-SignUp-Sucess.php?");
}
 ...
 <html>
   ...
   <body id="login">
     <div class="container">
       <form class="#" action="SignUpSuccess.php" method="post">
         ...
         <center>
         <h2 class="form-signin-heading" style="color:#006400;">Sign Up successful.</h2>
         <br><br>
             ...
             <tbody>
                 ...
                 <tr>
                   ...
                   <td>
                     <td>
                       <h2>
                       <?php echo $_SESSION['registrationCode']; ?>
                       </h2>
                     </td>
                 </tr>
                 <tr>
                   <td ><label for="" class="control-label col-xs-6 fontcolor" >Email:</label></td>
                   <td>
                     <td>
                       <h2>
         ...
         <br><br><br>
         <label for="">Login to access your account</label>
         <br><br><br>
