...
if (isset($_POST['btn-Search']))
{
  ...
  $getRecord->GetMaternalHealthRecords($actualId);
}
  ...
  <div class="col-xs-offset-3">
    ...
    if(isset($_GET['iderror']))
    {
      ...
      <div class='alert alert-error'>
        ...
        <strong><h4>No Maternal Health records for this ID</h4></strong>
      </div>
      <?php
    }
    ?>
...
<br><br>
<form class="" action="View-Maternal-Health-Records-Search.php" method="post">
  <div id="page-wrap">
    <table  width="180%" height="100%" cellspacing="20" cellpadding="20">
      <thead>
        <tr>
          <th><center><h3 style="color: red;">View Maternal Health Records Search</h3></center></th>
        </tr>
      </thead>
      <table width="200%"height="200" cellspacing="50" cellpadding="50">
        ...
        <tbody>
          ...
          <tr>
            <td>
              <center>
                <input id="bordershadow"type="text" name="maternalHealth_search" value="" class="search col-xs-offset-3" style=" width:60%; height: 100%; font-size: 16px;" placeholder="Example: ANC1" required>
              </center>
            </td>
          </tr>
          <tr>
